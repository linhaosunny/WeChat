//
//  CountrySelectedViewController.m
//  WeChat
//
...
@interface CountrySelectedViewController ()

@end

@implementation CountrySelectedViewController
...
- (void)setCountrySelectView{
    [self.navigationItem setTitle:@"选择国家和地区"];
